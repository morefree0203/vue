<template>
  <div class="supervisor-evaluation">
    ...
    <!-- 评价对话框 -->
    <el-dialog title="督导评价" v-model="dialogVisible">
      <el-form :model="evalForm" label-width="100px">
        ...
        <el-form-item label="上传照片">
          <el-upload
            action="http://localhost:8080/api/evaluation/supervisor/upload"
...
function fetchCourses() {
  axios.get('http://localhost:8080/api/evaluation/supervisor/courses', {
    params: { supervisorId: userStore.userId }
  })
    .then(res => {
...
function submitEvaluation() {
  ...
  axios.post('http://localhost:8080/api/evaluation/supervisor/submit', {
    supervisorId: userStore.userId,
