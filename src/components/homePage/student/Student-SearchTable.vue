...
import Form from '@/components/homePage/student/Student-form.vue'
...
<template>
  <div>
    <el-table :data="tableList" height="500" ref="table" style="width: 100%" :row-class-name="tableRowClassName">
      ...
      <el-table-column prop="enrolledTime" label="入学时间" min-width="120" />
  ...
  <el-dialog v-model="dialogFormVisible" title="编辑学生" width="500">
